...
public class productCatalogview extends AppCompatActivity
{
    ...
    @Override public void onCreate(Bundle bundle)
    {
        ...
        Spinner spinner=(Spinner)findViewById(R.id.spintool);
        ...
        new Handler().post(new Runnable()
        {
            ...
            {
                customCursorAdapter=new CustomCursorAdapter(productCatalogview.this,db.getAllProductsInCatalog(tableName));
                listView.setAdapter(customCursorAdapter);
                Toast.makeText(getBaseContext(),"Contains "+db.getCountOfProductsInCatalog(tableName),Toast.LENGTH_LONG).show();
            }
        });
        listView.setOnCreateContextMenuListener(this);
        Button recordbtn=(Button)findViewById(R.id.recordSales);
        recordbtn.setOnClickListener(new View.OnClickListener()
        {
            @Override public void onClick(View v)
            {
                ...
                Intent recordIntent=new Intent(productCatalogview.this,recordScreen.class);
                recordIntent.putExtra("TABLENAME",tableName);
        ...
        viewReport.setOnClickListener(new View.OnClickListener()
        {
           ...
           {
               String sales_record_table=tableName+"_Sales_Records";
               Intent viewReport=new Intent(productCatalogview.this,ReportMenu.class);
    ...
    public void reQueryProductList(final String table_name)
    {
        new Handler().post(new Runnable()
        {
            @Override public void run()
            {
                   ...
                   databaseManager db=new databaseManager(productCatalogview.this);
                   SQLiteDatabase sqliteDb=db.getReadableDatabase();
                   String sql="SELECT * FROM "+table_name;
                   Cursor c=sqliteDb.rawQuery(sql,null);
                   CustomCursorAdapter adapter=new CustomCursorAdapter(productCatalogview.this,c);
    ...
    public void addProductDetails(String username)
    {
        ...
        final Dialog newbox=new Dialog(this);
            ...
            @Override public void onClick(View v)
            {
                try {
                    ...
                    if (!((descriptionedit.getText().toString().equals("")) || (priceedit.getText().toString().equals("")) ||
                        ...
                        Toast.makeText(getBaseContext(),"Product details stored successfully!",Toast.LENGTH_LONG).show();
                        //clear inputs
                        ...
                        {
                        Toast.makeText(getBaseContext(),"Invalid product details provided!",Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(getBaseContext(),hint1 + "\n" + hint2 + "\n" + hint3 + "\n",Toast.LENGTH_LONG).show();
                        }
                    }
                catch(NumberFormatException e)
                {
                    Toast.makeText(getBaseContext(),"Invalid number format ",Toast.LENGTH_LONG).show();
                }
    ...
    public void editProductDetail(final int position,final String table_name)
    {
        ...
        final Dialog editbox=new Dialog(productCatalogview.this);
            ...
            @Override public void onClick(View v)
            {
                    //get contents of dialog input fields
                        ...
                        if (!((productDescription.equals("")) || (productDescription.length() < 2))) {
                            ...
                            Toast.makeText(getBaseContext(), "Provide Valid product details", Toast.LENGTH_LONG).show();
                    }
                    catch (SQLiteException sqle)
                    {
                        Toast.makeText(getBaseContext(),sqle.getMessage(),Toast.LENGTH_LONG).show();
                    }
                    catch (NumberFormatException e)
                    {
                        Toast.makeText(getBaseContext(),e.getMessage(),Toast.LENGTH_LONG).show();
                    ...
                    {
                        Toast.makeText(getBaseContext(),ife.getMessage(),Toast.LENGTH_LONG).show();
                    }
    ...
    public void deleteProductDetail(final int position, final String table_name)
    {
        ...
        deleteAlert.setPositiveButton("Yes",new DialogInterface.OnClickListener()
        {
            @Override public void onClick(DialogInterface d,int which)
            {
                ...
                Toast.makeText(getBaseContext(),description+" deleted successfully!"+" at "+position,Toast.LENGTH_LONG).show();
    ...
    @Override public void onActivityResult(int requestCode,int ResultCode,Intent data)
    {
        ...
        if (requestCode==TAKE_PHOTO_CODE && ResultCode==RESULT_OK)
        {
            ...
            {
                Toast.makeText(getBaseContext(),"image path captured successfully!",Toast.LENGTH_LONG).show();
                imgpathedit.setText(String.valueOf(pictureLocationValue));
            }
            else{
            Toast.makeText(getBaseContext(),"Failure capturing image path, try again.",Toast.LENGTH_LONG).show();
            }
